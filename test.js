function test() {
    ...
    if (false) {
        for (var t = s_Month; t <= e_Month; t++) {
            ...
            var urls = ['https://riigihanked.riik.ee:443/rhr/api/public/v1/opendata/notice/' + s_Year + '/month/' + t + '/xml'
                , 'https://riigihanked.riik.ee:443/rhr/api/public/v1/opendata/notice_award/' + s_Year + '/month/' + t + '/xml']
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < nodes.length; i++) {
                        ...
                        HT.file_name = 'HT_' + s_Year + '_' + t + '.xml';
